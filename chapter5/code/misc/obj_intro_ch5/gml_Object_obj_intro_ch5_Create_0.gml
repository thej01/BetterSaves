...
logoDel = scr_marker_fancy(roomCenterX, roomCenterY, IMAGE_LOGO_CENTER_SEPARATE_GLOW_3);
logoDel.image_alpha = 0;
logoDel.image_index = 0;
logoDel.depth = 19900;
logoDel.offset = 32;
logoTa = scr_marker_fancy(roomCenterX, roomCenterY, IMAGE_LOGO_CENTER_SEPARATE_GLOW_3);
logoTa.image_alpha = 0;
logoTa.image_index = 1;
logoTa.depth = 19900;
logoTa.offset = 169;
logoRune = scr_marker_fancy(roomCenterX, roomCenterY, IMAGE_LOGO_CENTER_SEPARATE_GLOW_3);
logoRune.image_alpha = 0;
logoRune.image_index = 2;
logoRune.depth = 19900;
logoRune.offset = 284;
logoAll = scr_marker_fancy(roomCenterX, roomCenterY, IMAGE_LOGO_256);
