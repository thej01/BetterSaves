function scr_saveprocess(arg0, type = global.bettersaves_save_types.normal)
{
    ...
    if (global.filechoice_route == "_b")
        side_b = true;
    var file = scr_bettersaves_get_saveprocess_file(global.filechoice, type, global.chapter, side_b);
    var myfileid = ossafe_file_text_open_write(file);
